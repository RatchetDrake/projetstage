<?php
include('../Controle/creationhistoireA_ctrl.php');
...
<body>
    ...
    <form id="proposer-suite" method="POST" action="../Controle/creationhistoireA_ctrl.php" style="text-align: center; margin: 0 auto;">
